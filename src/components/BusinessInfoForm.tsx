...
const BusinessInfoForm: React.FC<BusinessInfoFormProps> = ({
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    onSubmit({
      ...
      business_description: formData.value_props,
      target_market: formData.market_geo,
          ...
          <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 12 }}>
              <TextField
                ...
                value={product.persona}
                onChange={(e) =>
                  handleProductServiceChange(index, "persona", e.target.value)
                }
